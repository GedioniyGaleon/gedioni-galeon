...
export const guest = (() => {
    ...
    const open = (button) => {
        ...
        welcome?.classList.add('letter-opening');
        ...
        util.timeOut(() => {
            ...
            util.changeOpacity(welcome, false).then((el) => el.remove());
        }, 900);
    };
    ...
    const buildGoogleCalendar = () => {
        ...
        const data = new URLSearchParams({
            action: 'TEMPLATE',
            text: 'Boda de Gedy y Galeon',
            dates: `${formatDate('2026-10-10 10:00')}/${formatDate('2026-10-10 12:00')}`,
            details: 'Con el mayor respeto, les invitamos a celebrar junto a nosotros este momento tan especial. Gracias por acompañarnos y por su amor, apoyo y bendiciones.',
            location: 'Iglesia Ebenezer - Urb Los Licenciados Mz B Lt 4, barrio Santa Ana.',
            ctz: config.get('tz'),
        });
     ...
     */
    const booting = async () => {
        if (document.body.getAttribute('data-booted') === 'true') {
            return;
        }
